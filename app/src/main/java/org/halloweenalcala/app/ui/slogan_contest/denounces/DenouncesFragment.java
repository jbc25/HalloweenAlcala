 ...
 */
public class DenouncesFragment extends BaseFragment implements DenouncesView, DenouncesAdapter.OnItemClickListener {


    private DenouncesPresenter presenter;
    private RecyclerView recyclerSlogans;
    private DenouncesAdapter adapter;

    public DenouncesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        presenter = DenouncesPresenter.newInstance(this, getActivity());
    ...
    public void onValidateClick(int position) {
        presenter.onValidateSloganButtonClick(position);
    }

    @Override
    public void onDeleteSloganClick(int position) {
        presenter.onDeleteSloganButtonClick(position);
    }

    @Override
    public void onBanUserClick(int position) {
        presenter.onBanUserButtonClick(position);
    }
    ...
    public void showSlogans(List<Slogan> slogans) {
        if (adapter == null) {
            adapter = new DenouncesAdapter(getActivity(), slogans);
