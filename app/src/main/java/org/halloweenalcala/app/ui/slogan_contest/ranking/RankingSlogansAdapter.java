...
public class RankingSlogansAdapter extends RecyclerView.Adapter<RankingSlogansAdapter.ViewHolder> {
    ...
    public RankingSlogansAdapter(Context context, List<Slogan> slogans) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View contactView = LayoutInflater.from(context).inflate(R.layout.row_ranking_slogan, parent, false);
