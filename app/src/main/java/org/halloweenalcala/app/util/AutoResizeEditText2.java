...
public class AutoResizeEditText2 extends AppCompatEditText {
    ...
    public AutoResizeEditText2(final Context context) {
        this(context, null, android.R.attr.editTextStyle);
    }

    public AutoResizeEditText2(final Context context, final AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextStyle);
    }

    public AutoResizeEditText2(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        _sizeTester = new SizeTester() {
            ...
            public int onTestSize(final int suggestedSize, final RectF availableSpace) {
                ...
                if (transformationMethod != null)
                    text = transformationMethod.getTransformation(getText(), AutoResizeEditText2.this).toString().trim();
                else
